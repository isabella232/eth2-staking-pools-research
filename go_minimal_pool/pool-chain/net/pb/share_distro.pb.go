...
const (
	...
	ShareType_DKG ShareType = 0
	// Share type for distributing during an epoch
	ShareType_EPOCH ShareType = 1
)
...
func (ShareType) Descriptor() protoreflect.EnumDescriptor {
	return file_share_distro_proto_enumTypes[0].Descriptor()
}

func (ShareType) Type() protoreflect.EnumType {
	return &file_share_distro_proto_enumTypes[0]
}
...
type ShareDistribution struct {
	...
	Type            ShareType    `protobuf:"varint,1,opt,name=type,proto3,enum=v1.ShareType" json:"type,omitempty"`
	...
	ToParticipant   *Participant `protobuf:"bytes,4,opt,name=to_participant,json=toParticipant,proto3" json:"to_participant,omitempty"`
	Share           []byte       `protobuf:"bytes,5,opt,name=share,proto3" json:"share,omitempty"`
	Commitments     [][]byte     `protobuf:"bytes,6,rep,name=commitments,proto3" json:"commitments,omitempty"`
...
func (x *ShareDistribution) GetType() ShareType {
	if x != nil {
		return x.Type
	}
	return ShareType_DKG
}

func (x *ShareDistribution) GetId() []byte {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *ShareDistribution) GetPoolId() int32 {
	if x != nil {
		return x.PoolId
	}
	return 0
...
func (x *ShareDistribution) GetEpoch() int32 {
	if x != nil {
		return x.Epoch
	}
	return 0
...
var file_share_distro_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa1, 0x02, 0x0a, 0x11, 0x53, 0x68,
	...
	,
	...
	0x69, 0x67, 0x6e, 0x65, 0x72, 0x2f, 0x73, 0x69, 0x67, 0x6e, 0x42, 0x10, 0x5a, 0x0e, 0x2f, 0x70,
	0x6f, 0x6f, 0x6c, 0x2d, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_share_distro_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_share_distro_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_share_distro_proto_goTypes = []interface{}{
	(ShareType)(0),            // 0: v1.ShareType
	(*ShareDistribution)(nil), // 1: v1.ShareDistribution
	(*Participant)(nil),       // 2: v1.Participant
	(*StatusResponse)(nil),    // 3: v1.StatusResponse
}
var file_share_distro_proto_depIdxs = []int32{
	0, // 0: v1.ShareDistribution.type:type_name -> v1.ShareType
	2, // 1: v1.ShareDistribution.from_participant:type_name -> v1.Participant
	2, // 2: v1.ShareDistribution.to_participant:type_name -> v1.Participant
	1, // 3: v1.ShareDistributionService.NewShare:input_type -> v1.ShareDistribution
	3, // 4: v1.ShareDistributionService.NewShare:output_type -> v1.StatusResponse
...
func file_share_distro_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_share_distro_proto_enumTypes,
