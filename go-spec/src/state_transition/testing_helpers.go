...
func generateHeaderAndBody(
	...
	includeCreateStakeDeposit bool,
	includeCDTWithdrawal bool,
	cdtWithdrawalStatus uint32,
	cdtWithdrawalPubKey []byte,
	randao []byte,
	...
	body := &core.BlockBody{
		...
		StakeDeposits:		[]*core.StakeDeposit{},
		CDTWithdrawReq: 	[]*core.CDTWithdrawalRequest{},
	...
	if includeCreateStakeDeposit {
		body.StakeDeposits = append(body.StakeDeposits, &core.StakeDeposit{
			PubKey:               stakeDepositPubKey,
			TransactionHash:      []byte("tx hash"),
			Amount:               100,
		})
	}
	if includeCDTWithdrawal {
		body.CDTWithdrawReq = append(body.CDTWithdrawReq, &core.CDTWithdrawalRequest{
			PubKey:               cdtWithdrawalPubKey,
			Amount:               100,
			Status:               cdtWithdrawalStatus,
			ApprovalBlock:        0,
			Signature:            []byte("sig"),
		})
	}
